<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DGFScouting.Master" AutoEventWireup="true" CodeBehind="AddAccount.aspx.cs" Inherits="DGFScouting.AddAccount" UnobtrusiveValidationMode="None" %>
    ...
    <div class="container my-5">
        ...
        <div class="formBody">
            ...
            <div class="form-group row">
                ...
                <div>
                    <asp:Button ID="btnAddAccount" runat="server" Text="Add Account" CssClass="formButton col-2" OnClick="btnAddAccount_Click" />
                    <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="formButton col-2" OnClientClick="this.form.reset();return false;" />
                    <asp:Label ID="lblAddAccountError" runat="server" Text="Error: Account not added to the database" CssClass="alert alert-danger small font-weight-bold text-center" role="alert" Visible="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
